...
INSERT INTO employee (employee_id, dept_id, first_name, last_name, date_of_birth, cnic, email, designation, address, gender, absences, leaves) VALUES
                                                                                                                                                   ...
                                                                                                                                                   (6, 6, 'Ali', 'Khan', '1985-03-15', '12345-6789012-3', 'ali.khan@company.com', 'Driver', '123 Main Street, Lahore', 'Male', 2, 21),
                                                                                                                                                   (7, 6, 'Zain', 'Malik', '1990-05-20', '98765-4321098-7', 'zain.malik@company.com', 'Driver', '456 Elm Avenue, Karachi', 'Male', 1, 21),
                                                                                                                                                   (8, 4, 'Fatima', 'Ahmed', '1988-07-10', '34567-8901234-5', 'fatima.ahmed@company.com', 'Accountant', '789 Oak Road, Islamabad', 'Female', 0, 21),
                                                                                                                                                   (9, 4, 'Hassan', 'Iqbal', '1992-11-05', '54321-0987654-3', 'hassan.iqbal@company.com', 'Accountant', '101 Pine Lane, Peshawar', 'Male', 3, 21),
                                                                                                                                                   (10, 3, 'Ayesha', 'Noor', '1987-09-25', '11223-4455667-8', 'ayesha.noor@company.com', 'Supervisor', '234 Maple Drive, Faisalabad', 'Female', 0, 21),
                                                                                                                                                   (11, 3, 'Rehan', 'Ali', '1995-01-30', '22133-6677889-1', 'rehan.ali@company.com', 'Supervisor', '567 Birch Boulevard, Multan', 'Male', 2, 21);
...
INSERT INTO deliveries (delivery_id, order_id, vehicle_id, driver_id, departure_time, delivery_time) VALUES
                                                                                                         ...
                                                                                                         (2, 2, 2, 2, '2025-04-26 09:00:00', '2025-04-26 13:00:00'),
                                                                                                         (3, 3, 3, 1, '2025-04-27 10:00:00', '2025-04-27 14:00:00'),
                                                                                                         (4, 4, 4, 2, '2025-04-28 11:00:00', NULL),
...
VALUES
    (1, '2025-05-14', '08:55:00', '17:05:00', 'present'),
    (2, '2025-05-14', '09:30:00', '17:00:00', 'late'),
    (3, '2025-05-14', NULL, NULL, 'absent');

-- Insert records for tomorrow (2025-05-15)
INSERT INTO attendance (employee_id, date, clock_in, clock_out, status)
VALUES
    (1, '2025-05-15', '08:50:00', '17:10:00', 'present'),
    (2, '2025-05-15', '09:05:00', '16:50:00', 'late'),
    (3, '2025-05-15', '09:00:00', '17:00:00', 'present');
...
(302, 150000.00, 'deposit', '2025-03-15', 2, 'Bank Transfer'),   -- Sale Payment
(303, 180000.00, 'deposit', '2025-03-20', 1, 'Cash'),            -- Sale Payment
(304, 300000.00, 'deposit', '2025-03-25', 2, 'Bank Transfer');   -- Sale Payment
...
INSERT INTO sales (sale_id, transaction_id, order_id, units_sold, status) VALUES
                                                                              ...
                                                                              (2, 302, 2, 1300.0, 'Completed'),
                                                                              (3, 303, 3, 400.0, 'Completed'),
                                                                              (4, 304, 4, 1500.0, 'Completed');
