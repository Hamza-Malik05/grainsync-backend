...
const RegisterEmployeeUser = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/api/employees/unregistered')
    ...
    useEffect(() => {
        if (form.username.trim().length > 0) {
            axios.get(`http://localhost:8080/api/users/check-username`, {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            await axios.post('http://localhost:8080/api/users/register-from-employee', {
