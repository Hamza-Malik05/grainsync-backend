  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const employeeResponse = await axios.get(`http://localhost:8080/api/employees/${employee_id}`);
        ...
        const attendanceResponse = await axios.get(`http://localhost:8080/api/attendance/${employee_id}/history`);
