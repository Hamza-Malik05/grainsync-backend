...
const ManageDeliveries = () => {
    ...
    const handleCompleteDelivery = async (deliveryId) => {
        try {
            await axios.post(`http://localhost:8080/api/deliveries/${deliveryId}/complete`);
    ...
    const handleCancelDelivery = async (deliveryId) => {
        try {
            await axios.post(`http://localhost:8080/api/deliveries/${deliveryId}/cancel`);
    ...
    const handleModalSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`http://localhost:8080/api/deliveries/${selectedDelivery.delivery_id}`, updatedDelivery);
