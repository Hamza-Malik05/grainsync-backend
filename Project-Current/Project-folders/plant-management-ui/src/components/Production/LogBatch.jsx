...
export default function LogBatch() {
  ...
  const fetchEmployees = async () => {
    try {
      const res = await axios.get("http://localhost:8080/api/employees/production");
  ...
  const fetchProductStorageUnits = async () => {
    try {
      const res = await axios.get("http://localhost:8080/api/product-inventory-storage/product-inventory");
